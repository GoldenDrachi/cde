...
public class ColorPickerComponent extends BaseComponent {
    ...
    public void draw(OwoUIDrawContext context, int mouseX, int mouseY, float partialTicks, float delta) {
        ...
        var buffer = class_289.method_1348().method_60827(class_293.class_5596.field_27382, class_290.field_1576);
        var matrix = context.method_51448().method_23760().method_23761();

        buffer.method_22918(matrix, this.renderX(), this.renderY(), 0)
            .method_22915(this.hue, 0f, 1f, 1f);
        buffer.method_22918(matrix, this.renderX(), this.renderY() + this.renderHeight(), 0)
            .method_22915(this.hue, 0f, 0f, 1f);
        buffer.method_22918(matrix, this.renderX() + this.colorAreaWidth(), this.renderY() + this.renderHeight(), 0)
            .method_22915(this.hue, 1f, 0f, 1f);
        buffer.method_22918(matrix, this.renderX() + this.colorAreaWidth(), this.renderY(), 0)
            .method_22915(this.hue, 1f, 1f, 1f);
