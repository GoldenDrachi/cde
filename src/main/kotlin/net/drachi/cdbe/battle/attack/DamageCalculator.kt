...
object DamageCalculator {
    fun calculateDamage(
        ...
        if (attackerItem != null) {
            val itemStrategy = net.drachi.cdbe.battle.item.ItemRegistry.getItem(attackerItem)
        ...
        val globalDamageMultiplier = net.drachi.cdbe.config.ConfigManager.config.damageMultiplier
        val globalHpMultiplier = net.drachi.cdbe.config.ConfigManager.config.hpMultiplier
