...
import net.drachi.cde.dungeonsengine.mechanics.HazardMechanic
...
import net.drachi.cde.dungeonsengine.mechanics.HazardMechanicClient
        ...
        if (!level.isClientSide) {
            ...
            if (!allowed && (entity is ServerPlayer || entity is PokemonEntity)) {
                ...
                if (dx < 0.4 && dz < 0.4) {
                    ...
                    val safePos = net.drachi.cde.dungeonsengine.data.DungeonManager.findSafeSpawn(level as net.minecraft.server.level.ServerLevel, pos)
