package net.drachi.cde.battleengine.client.gui
...
object BattleHudOverlay : HudRenderCallback {
    ...
    override fun onHudRender(drawContext: GuiGraphics, tickDelta: net.minecraft.client.DeltaTracker) {
        ...
        val weather = net.drachi.cde.battleengine.client.ClientCombatManager.activeWeather
        ...
        for (i in 0 until 4) {
            ...
            if (move != null) {
                ...
                val remainingCd = net.drachi.cde.battleengine.client.ClientCombatManager.getRemainingCooldown(fullId)
                ...
                val lockedMoveId = net.drachi.cde.battleengine.client.ClientCombatManager.lockedMoveId
                ...
                val keyHint = when (i) {
                    0 -> net.drachi.cde.battleengine.client.KeybindManager.move1Key.translatedKeyMessage.string
                    1 -> net.drachi.cde.battleengine.client.KeybindManager.move2Key.translatedKeyMessage.string
                    2 -> net.drachi.cde.battleengine.client.KeybindManager.move3Key.translatedKeyMessage.string
                    3 -> net.drachi.cde.battleengine.client.KeybindManager.move4Key.translatedKeyMessage.string
                    else -> ""
                }
        ...
        // Draw Active Item
        val activeItem = net.drachi.cde.battleengine.client.ClientCombatManager.activeItem
        if (activeItem != "none") {
        ...
        // --- Render Player Stats ---
        val playerStats = net.drachi.cde.battleengine.client.ClientTargetManager.entityStats[client.player!!.id]
        ...
        if (targetId != -1) {
            ...
            if (target != null) {
                ...
                val targetStats = net.drachi.cde.battleengine.client.ClientTargetManager.entityStats[targetId]
