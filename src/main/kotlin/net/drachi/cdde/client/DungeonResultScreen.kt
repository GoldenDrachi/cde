...
import net.drachi.cdde.network.DungeonResultPayload
...
class DungeonResultScreen(private val payload: DungeonResultPayload) : BaseOwoScreen<FlowLayout>() {
    ...
    override fun build(rootComponent: FlowLayout) {
        ...
        // Title
        mainPanel.child(
            Components.label(Component.translatable("gui.cdde.result.title"))
                .shadow(true)
        ...
        // Place
        mainPanel.child(
            Components.label(Component.translatable("gui.cdde.result.place", payload.dungeonName))
        ...
        // Close Button
        val closeBtn = Components.button(Component.translatable("gui.cdde.result.close")) {
